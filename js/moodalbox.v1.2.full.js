...
var _DEF_CONTENTS_WIDTH = 150; // Default width of the box (px) - used for resetting when a different setting was used
var _DEF_CONTENTS_HEIGHT = 150; // Default height of the box (px) - used for resetting when a different setting was used
